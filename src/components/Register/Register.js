...
<main className="pa4 black-80">
  <form className="measure">
    <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
      ...
      <div className="mt3">
        <label style={{fontFamily:"Roboto Mono"}} className="db fw6 lh-copy f6" for="email-address">Name</label>
...
<MDBBtn onClick={() => onRouteChange('home')} style={{fontFamily:"Roboto Mono", width: 300}} color="mdb-color">CLICK TO REGISTER</MDBBtn>
	</div>
